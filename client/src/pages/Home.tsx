      ...
      <section id="top" className="hero-section">
        <div className="hero-copy">
          ...
          <div className="hero-ctas">
            ...
            <a className="button-text" href="/manus-storage/resume_da120710.pdf" target="_blank" rel="noreferrer" aria-label="Open Om Aditya Mishra resume">VIEW RESUME <ExternalLink size={15} /></a>
          </div>
