      ...
      <section id="top" className="hero-section">
        <div className="hero-copy">
          ...
          <div className="hero-ctas">
            ...
            <a className="button-text" href="/manus-storage/om_aditya_mishra_linked_resume_19b31d27.pdf" target="_blank" rel="noreferrer" aria-label="Open Om Aditya Mishra resume">VIEW RESUME <ExternalLink size={15} /></a>
          </div>
